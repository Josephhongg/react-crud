...
const PlayerDeleteForm = (props) => {
  ...
  const deleteLeague = async () => {
    // sends the playerId data in a delete request
    try {
      const res = await axios.delete(`${BASE_URL}/players/${playerId}`, {
        playerId: playerId,
      })
  ...
  // returns delete player form with input field of playerId
  return (
    <>
      <h1 style={{ marginTop: '10px' }}>Delete Player</h1>
...
export default PlayerDeleteForm
